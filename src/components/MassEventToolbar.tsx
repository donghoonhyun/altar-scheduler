...
import { Copy, Lock, Send, StopCircle, Settings, Check, Bot, Archive } from 'lucide-react';
    ...
    <div className="flex flex-col gap-2 mb-4 w-full">
      ...
      <div className="flex flex-wrap items-center gap-1.5 justify-center">
        ...
        <Button
          variant="toolbar"
          className={cn(
            'border-red-500 text-red-700 dark:text-red-400 dark:border-red-600',
      ...
      <div className="flex flex-wrap items-center gap-1.5 justify-end">
        ...
        <Button
          variant="toolbar"
          className="border-gray-300 text-gray-600 dark:text-gray-400 dark:border-gray-600 hover:bg-gray-50 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
